  ...
  return (
    <div className={classes.options}>
      <div style={{ marginBottom: "0.1rem" }}>
        <h2 style = {{color:"rgb(224, 48, 145)"}}>Account Info</h2>
        <Input
          size="large"
          placeholder="Name"
          prefix={<UserOutlined />}
        ...
        <div className={classes.share_options}>
          <CopyToClipboard text={me}>
            <Button
              ...
              tabIndex="0"
              onClick={() => message.success(" Copied successfully!")}
            >
              Copy code
            </Button>
          </CopyToClipboard>
          ...
          <div className={classes.share_social}>
            <WhatsappShareButton
              url={`https://video-chat-anisha.web.app/`}
            ...
            <TwitterShareButton
              ...
              className={classes.share_icon}
            >
              <TwitterIcon size={30} round className={classes.share_border} />
            </TwitterShareButton>
          </div>
        </div>
      </div>
      <div style={{ marginBottom: "0.5rem" }}>
        <h2 style = {{color:"rgb(224, 48, 145)"}}>Make a call</h2>
